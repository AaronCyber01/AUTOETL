      ...
      <main className="pt-16 min-h-screen technical-grid relative h-full flex flex-col overflow-hidden">
        ...
        <div className="p-8 max-w-[1600px] mx-auto w-full flex-1 flex flex-col min-h-0 relative z-10 overflow-hidden">
          ...
          <div className="flex-1 grid grid-cols-1 xl:grid-cols-2 gap-8 min-h-0 overflow-hidden mb-6">
             {/* LEFT COLUMN */}
             <div className="flex flex-col min-h-0 border border-white/5 bg-surface-container/30 rounded-xl p-6 overflow-y-auto custom-scrollbar">
                ...
                <div className="shrink-0 flex flex-col gap-3">
                   ...
                   />
                   <Button 
                      className="bg-primary hover:bg-primary-dim text-on-primary font-headline font-bold text-lg h-14 rounded-xl mt-2 transition-all neon-orange-shadow"
                      onClick={() => runPipeline()}
             ...
             {/* RIGHT COLUMN */}
             <div className="flex flex-col min-h-0 border border-white/5 bg-surface-container/30 rounded-xl p-6 overflow-hidden">
          ...
          <section className="shrink-0 bg-surface-container-lowest/50 border border-white/5 rounded-xl p-4 glow-inner">
